...
def dashboard():
    ...
    print(courses)
    return render_template('dashboard.html', formu=form, email_templates = email_templates, tempform = tempform, email=email, keyform=keyform, compainform = compainform, courses = courses)
